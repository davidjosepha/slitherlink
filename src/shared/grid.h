...
class Grid : public Lattice {
    public:
        ...
        bool getUpdateMatrix(int i, int j) const { return updateMatrix_[i][j]; };
        bool getContraMatrix(int i, int j) const { return contraMatrix_[i][j]; };
