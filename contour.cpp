...
bool Contour::sharesEndpoint(Contour & contour) {
    return ((start_[0] == contour.start_[0] and start_[1] == contour.start_[1]) ||
            (start_[0] == contour.end_[0] and start_[1] == contour.end_[1]) ||
            (end_[0] == contour.start_[0] and end_[1] == contour.start_[1]) ||
            (end_[0] == contour.end_[0] and end_[1] == contour.end_[1]));
}
...
void Contour::addContour(Contour & contour) {
    if (start_[0] == contour.start_[0] and start_[1] == contour.start_[1]) {
        ...
        length_++;
    } else if (start_[0] == contour.end_[0] and start_[1] == contour.end_[1]) {
        start_[0] = contour.start_[0];
        start_[1] = contour.start_[1];
        length_++;
    } else if (end_[0] == contour.start_[0] and end_[1] == contour.start_[1]) {
        end_[0] = contour.end_[0];
        end_[1] = contour.end_[1];
        length_++;
    } else if (end_[0] == contour.end_[0] and end_[1] == contour.end_[1]) {
